...
function showAnswer1() {
    ...
    document.getElementById("question-2").style.fontWeight = "500";
    document.getElementById("question-3").style.fontWeight = "500";
    document.getElementById("question-4").style.fontWeight = "500";
    document.getElementById("question-5").style.fontWeight = "500";
}
...
function showAnswer2() {
    ...
    downArrow4.style.transform = 'rotate(360deg)';
    downArrow5.style.transform = 'rotate(360deg)';
    document.getElementById("question-1").style.fontWeight = "500";
